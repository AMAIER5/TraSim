...
# PPBLS example files:
MECHANISM_FILE = BASE_DIR / "PBLS_mechanism_sec1.csv"
TARGET_FILE = BASE_DIR / "PBLS_target_curve_csv_mechanism_sec1.csv"
...
rng = random.Random()  # Random seed for better performance
