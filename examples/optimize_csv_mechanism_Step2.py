"""
examples/optimize_csv_mechanism_Step2.py

Schritt 2: Mechanik, die außerhalb des relevanten Bereichs blockieren kann
...
- Eingangshebel: Drehpunkt bei (0,0,0), Laenge 100mm, Winkelbereich [-90, 90]
- Ausgangshebel: Drehpunkt bei (100,0,0), Laenge 100mm, Winkelbereich [-45, 45]

Die Zielkurve ist eine einfache 1:1 Uebersetzung von -45 bis +45.

ACHTUNG: Der Ausgangshebel hat einen eingeschraenkten Winkelbereich [-45, 45].
Dies fuehrt dazu, dass der Mechanismus bei grossen Eingangswinkeln (nahe -90 oder +90)
blockieren KANN, da der Ausgangshebel seinen maximalen Ausschlag erreicht.
Innerhalb des relevanten Bereichs [-45, 45] funktioniert der Mechanismus jedoch einwandfrei.
"""
...
MECHANISM_FILE = BASE_DIR / "mechanism_Step2.csv"
TARGET_FILE = BASE_DIR / "target_curve_Step2.csv"
...
print("=" * 80)
print("SCHRITT 2: MECHANIK MIT BLOCKIERUNG AUSSERHALB DES RELEVANTEN BEREICHS")
print("=" * 80)
...
print("\nACHTUNG: Hebel 2 hat einen eingeschraenkten Winkelbereich [-45, 45]!")
print("         Dies kann zu Blockierungen bei grossen Eingangswinkeln fuehren.")
...
print("=" * 80)
print("\nHinweis: Dieser Mechanismus hat einen eingeschraenkten Ausgangshebel")
print("Winkelbereich [-45, 45] fuer den Ausgang, waehrend der Eingang [-90, 90] hat.")
print("Dies fuehrt zu Blockierungen bei grossen Eingangswinkeln (ausserhalb [-45, 45]).")
print("Innerhalb des relevanten Bereichs [-45, 45] funktioniert der Mechanismus jedoch.")
print("\nVergleich mit Schritt 1:")
print("  Schritt 1: Beide Hebel [-50, 50] -> nie blockierend (Rhombus)")
print("  Schritt 2: Eingang [-90, 90], Ausgang [-45, 45] -> blockiert ausserhalb [-45, 45]")
print("=" * 80)
