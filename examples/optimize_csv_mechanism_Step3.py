...
Schritt 3: Zusaetzliche, nie blockierende Getriebestufe anhaengen

User I/O angles are in DEGREES.
Internal calculations use RADIANS.

Dieses Beispiel erweitert den Rhombus aus Schritt 1 um eine weitere,
ebenfalls nie blockierende Getriebestufe. Es verwendet einen Mechanismus
mit drei Hebeln:
- Eingangshebel (Hebel 1): Drehpunkt bei (0,0,0), Laenge 100mm, [-50, 50]
- Zwischenhebel (Hebel 2): Drehpunkt bei (100,0,0), Laenge 100mm, [-50, 50]
  getrieben von Hebel 1
- Ausgangshebel (Hebel 3): Drehpunkt bei (200,0,0), Laenge 100mm, [-50, 50]
  getrieben von Hebel 2
...
Dadurch kann keine der beiden Stufen theoretisch blockieren.

Die Zielkurve ist wie in Schritt 1 eine einfache 1:1 Uebersetzung
von -45 bis +45 Grad. Die zweite Stufe uebersetzt die Bewegung des
Zwischenhebels weiter 1:1 auf den Ausgangshebel, so dass die gesamte
Kette ebenfalls eine 1:1 Uebersetzung realisiert.
"""
...
print("=" * 80)
print("SCHRITT 3: ZUSAETZLICHE, NIE BLOCKIERENDE GETRIEBESTUFE ANHAENGEN")
print("=" * 80)
...
print("  Stufe 1: Hebel 1 -> Hebel 2 (Rhombus, nie blockierend)")
print("  Stufe 2: Hebel 2 -> Hebel 3 (Rhombus, nie blockierend)")
print("\nIn jeder Stufe entspricht die Stangenlaenge (100mm) genau dem Abstand")
print("der Drehpunkte (100mm). Dadurch kann keine Stufe theoretisch blockieren.")
...
print("Stangenlaenge. Dadurch kann keine der beiden Stufen theoretisch")
print("blockieren, und die gesamte Kette bleibt frei beweglich.")
print("\nDie zweite Stufe uebersetzt die Bewegung des Zwischenhebels weiter")
print("1:1 auf den Ausgangshebel, so dass die Kette ebenfalls eine 1:1")
print("Uebersetzung ueber den Bereich [-45, 45] realisiert.")
